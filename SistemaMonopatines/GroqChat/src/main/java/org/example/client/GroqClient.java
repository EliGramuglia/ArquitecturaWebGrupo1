...
public class GroqClient {
    ...
    public GroqClient(
        ...
        if (apiKey == null || apiKey.isBlank()) {
            throw new IllegalStateException("GROQ API key no inyectada. Revisá GROQ_API_KEY o groq.api-key.");
        }
    ...
    public String chat(String prompt) {
        ...
        body.put("temperature", 0.1); // buscamos comportamiento más determinístico
