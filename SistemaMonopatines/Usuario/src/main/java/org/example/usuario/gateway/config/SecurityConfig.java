package org.example.usuario.gateway.config;

import lombok.extern.slf4j.Slf4j;
import org.example.usuario.gateway.security.AuthorityConstant;
import org.example.usuario.gateway.security.jwt.JwtFilter;
import org.example.usuario.gateway.security.jwt.TokenProvider;
    ...
    public SecurityFilterChain filterChain( final HttpSecurity http ) throws Exception {
        ...
        http
            ...
            .authorizeHttpRequests( authz -> authz
                    ...
                    .requestMatchers(HttpMethod.POST, "/api/viajes/tarifas/ajustar").hasAuthority(AuthorityConstant.ADMINISTRADOR)
